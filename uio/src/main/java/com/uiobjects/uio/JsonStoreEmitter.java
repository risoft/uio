...
public class JsonStoreEmitter implements Emitter {
	
	private final Context context;
	
	public JsonStoreEmitter(Context context)
	{
	...
	public void emit(Object form) throws IOException
	{
		...
		Template t =context.getTemplateFactory().getTemplate(JsonStoreEmitter.class);
